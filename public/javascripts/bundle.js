...
React.render(
  React.createElement(FinanceU, null),
  document.getElementById('financeU')
);

},{"./components/main.jsx":2,"react":158}],2:[function(require,module,exports){
var React = require('react');
...
},{"./ticker_box.jsx":3,"react":158}],3:[function(require,module,exports){
var React = require('react');
...
React.createElement("div", {className: "row"}, 
  React.createElement("div", {className: "col-lg-12"}, 
    React.createElement("form", {id: "tickerForm", className: "topBefore"}, 
      React.createElement("input", {id: "tickerInput", type: "text", placeholder: "TICKER", ref: "myTickerInput"}), 
      React.createElement("input", {id: "submit", type: "submit", value: "GO!", onClick: this.handleClick})
    )
  )
)
...
React.createElement("div", {className: "col-lg-2"}, 
  React.createElement("div", {className: "alert alert-success min-alert-height", role: "alert"}, 
    React.createElement("div", {className: "text-center"}, React.createElement("strong", null, infoCol.Name)), 
    React.createElement("div", {id: infoCol.Id, className: "text-center"})
  )
)
    );
  });
...
var TickerBox = React.createClass({displayName: "TickerBox",
  render: function() {
    return (
      React.createElement("div", {className: "row well top-well"}, 
        React.createElement(TickerForm, null), 
        React.createElement(TickerInfoRow, null)
      )
    );
  }
});
